...
interface SpammerOperationsProps {
  subscriber: Pick<Subscriber, "id" | "status" | "verifiedByUserId">
  newsletter: Newsletter
}

export function SpammerOperations({ subscriber, newsletter }: SpammerOperationsProps) {
  ...
  const showVerifyButton = (subscriber.status != SubscriberStatus.VERIFIED) || (subscriber.status == SubscriberStatus.VERIFIED && subscriber.verifiedByUserId == null)
